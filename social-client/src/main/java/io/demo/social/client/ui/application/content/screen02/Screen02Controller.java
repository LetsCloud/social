package io.demo.social.client.ui.application.content.screen02;
 ...
 * the License.
 */
@Controller(route = "/application/screen02", selector = "content", componentInterface = IScreen02Component.class, component = Screen02Component.class)
public class Screen02Controller extends AbstractComponentController<SocialContext, IScreen02Component, HTMLElement>

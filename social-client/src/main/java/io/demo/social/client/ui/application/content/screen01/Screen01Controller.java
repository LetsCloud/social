package io.demo.social.client.ui.application.content.screen01;
 ...
 * the License.
 */
@Controller(route = "/application/screen01", selector = "content", componentInterface = IScreen01Component.class, component = Screen01Component.class)
public class Screen01Controller extends AbstractComponentController<SocialContext, IScreen01Component, HTMLElement>

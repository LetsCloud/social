package io.demo.social.client.ui.application.content.screen05;
 ...
 */
@Controller(
    route = "/application/screen05",
    selector = "content",
    componentInterface = IScreen05Component.class,
    component = Screen05Component.class
)
public class Screen05Controller extends AbstractComponentController<SocialContext, IScreen05Component, HTMLElement> implements IScreen05Component.Controller {
  private MyModel model;

  public Screen05Controller() {
  }
  ...
  public void start() {
    ...
    eventBus.fireEvent(new StatusChangeEvent("active screen: >>Screen05<<"));
  }
}

 ...
 */
public class Screen05Component extends AbstractComponent<IScreen05Component.Controller, HTMLElement> implements IScreen05Component {
  private Card card;

  public Screen05Component() {
    super();
  }
